...
(function () {
  ...
  function removeHeaderWhatsApp() {
    document.querySelectorAll('.header-wa-btn, .header-actions a[href*="wa.me"]').forEach(function (el) {
      el.remove();
    });
    document.querySelectorAll('.header-actions a').forEach(function (a) {
      if (a.querySelector('.fa-whatsapp')) a.remove();
    });
  }
